...
public class WhatsappController {
    ...
    public String createUser(@RequestBody String name, String mobile) throws Exception {
        ...
        if(whatsappService.createUser(name,mobile)) try {
            throw new Exception("Mobile no already exists in the database");
        } catch (Exception e) {
    ...
    public int sendMessage(@RequestParam Message message, User sender, Group group) throws Exception{
    ...
    public String changeAdmin(@RequestParam User approver, User user, Group group) throws Exception{
        //Throw "Group does not exist" if the mentioned group does not exist
